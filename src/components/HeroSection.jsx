...
export default function HeroSection() {
    return (
        ...
        >
            ...
            <div className='col-span-1 md:col-span-2 w-full text-center md:text-left md:place-self-start my-auto sm:pl-4 xl:pl-16 '>
                ...
                <p className="text-zinc-500 text-base sm:text-lg lg:text-xl mb-6">
                    I&apos;m Skilled in Python, Django, and Django REST Framework, I build scalable APIs and backend solutions focused on performance and reliability for modern web applications. Passionate about clean code and seamless user experience, I create efficient, maintainable backend architectures..
                </p>

                <div>
                    <Link to='https://drive.google.com/file/d/10vCnJHnpDHLEjGR0rXNp3oJ9Br1ExA85/view?usp=sharing' target='_blank'>
